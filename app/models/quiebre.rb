...
class Quiebre
	...
	def self.run1
		Quiebre.agregar(DateTime.now, 123,"77777777-7",)
		Quiebre.agregar("2014-04-01", 12,"55555555-5",)
		Quiebre.agregar("2014-05-22", 13,"6666666-6",)
		Quiebre.agregar(DateTime.now, 23,"12312312-3",)
		Quiebre.agregar("2015-04-11", 21,"3333333-3",)
		Quiebre.agregar("2013-11-11", 123,"2222222-2",)
	end
